...
{
    public class Season : Core.IdentifiedObject
    {
		...
		public override bool Equals(object obj)
		{
			...
			{
				Season x = (Season)obj;
				return (this.endDate == x.endDate && this.startDate == x.startDate && CompareHelper.CompareLists(this.seasonDayTypeSchedules, x.seasonDayTypeSchedules));
			}
			else
			{
				return false;
