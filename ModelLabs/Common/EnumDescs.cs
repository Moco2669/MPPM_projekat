...
namespace FTN.Common
{
	public class EnumDescs
	{
		...
		public EnumDescs()
		{
			...
			property2enumType.Add(ModelCode.BASICINTERVALSCHEDULE_V1MP, typeof(UnitMultiplier));
			property2enumType.Add(ModelCode.BASICINTERVALSCHEDULE_V1U, typeof(UnitSymbol));	
			property2enumType.Add(ModelCode.BASICINTERVALSCHEDULE_V2MP, typeof(UnitMultiplier));
			property2enumType.Add(ModelCode.BASICINTERVALSCHEDULE_V2U, typeof(UnitSymbol));
		}
